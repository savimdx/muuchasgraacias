...
export default function App() {
  return (
    <div className="relative min-h-screen bg-slate-900 text-slate-100 antialiased overflow-x-hidden selection:bg-orange-500 selection:text-slate-950 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-2xl w-full bg-slate-900/90 border border-slate-800 rounded-3xl p-8 sm:p-12 shadow-2xl relative z-10 text-center space-y-8 backdrop-blur-md">
        ...
        <div className="space-y-4 text-slate-300 text-sm sm:text-base leading-relaxed max-w-lg mx-auto">
          ...
          <div className="bg-slate-950/60 border border-slate-800 p-4 rounded-2xl text-xs text-orange-400 font-mono flex items-center justify-center gap-2 shadow-inner">
        ...
        <div className="pt-6 border-t border-slate-800/80 space-y-4">
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 text-xs text-slate-400 font-mono">
            <span>ID PEDIDO: <strong className="text-slate-200">#FUT-77291B</strong></span>
            <span>ESTADO: <strong className="text-emerald-400">APROBADO</strong></span>
            <span>SOPORTE: <strong className="text-slate-200">contacto@entrenamientosfutbolsala.online</strong></span>
          </div>
        </div>
